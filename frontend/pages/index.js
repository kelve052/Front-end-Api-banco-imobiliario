...
export default function Home() {
  return (
    <section className={styles.index}>
     ...
     <button className={styles.button_adicionar}>Adicionar participantes</button>
     ...
     <Image className={styles.imgs_backgrounds_4} src={"/images/backgrounds/background-4.png"} width={80} height={55} ></Image>
