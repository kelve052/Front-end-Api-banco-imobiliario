      ...
      <main className={styleEdicao.main}>
        ...
        <div className={styleEdicao.div_icons_equipe}>
          <Image
            ...
            id={1} className={`${styleEdicao.imgs_team} ${teamSelecionado === 1 ? styleEdicao.time_selecionado : ""}`} width={48} height={48} src={'/images/team/teamBlue.png'} />

          <Image
            onClick={() => { actionSelecionar(2); setTeam('Green'); }}
            id={2} className={`${styleEdicao.imgs_team} ${teamSelecionado === 2 ? styleEdicao.time_selecionado : ""}`} width={48} height={48} src={'/images/team/teamGreen.png'} />

          <Image
            onClick={() => { actionSelecionar(3); setTeam('Red'); }}
            id={3} className={`${styleEdicao.imgs_team} ${teamSelecionado === 3 ? styleEdicao.time_selecionado : ""}`} width={48} height={48} src={'/images/team/teamRed.png'} />

          <Image
            onClick={() => { actionSelecionar(4); setTeam('Yellow'); }}
            id={4} className={`${styleEdicao.imgs_team} ${teamSelecionado === 4 ? styleEdicao.time_selecionado : ""}`} width={48} height={48} src={'/images/team/teamYellow.png'} />

          <Image
            onClick={() => { actionSelecionar(5); setTeam('White'); }}
            id={5} className={`${styleEdicao.imgs_team} ${teamSelecionado === 5 ? styleEdicao.time_selecionado : ""}`} width={48} height={48} src={'/images/team/teamWhite.png'} />

          <Image
            onClick={() => { actionSelecionar(6); setTeam('Black'); }}
            id={6} className={`${styleEdicao.imgs_team} ${teamSelecionado === 6 ? styleEdicao.time_selecionado : ""}`} width={48} height={48} src={'/images/team/teamBlack.png'} />
        </div>
